...
function(mygui_demo PROJECTNAME)
	...
	include_directories( ${CMAKE_SOURCE_DIR}/hge/core/include )
	include_directories( ${CMAKE_SOURCE_DIR}/hge/helpers/include )
...
function(mygui_tool PROJECTNAME)
	...
	if( MSVC )
	SET_PROPERTY(GLOBAL PROPERTY USE_FOLDERS ON)
	SET_PROPERTY(TARGET ${PROJECTNAME}		PROPERTY FOLDER "3rd Party/MyGUI/Tools")
	endif()
...
function(mygui_plugin PROJECTNAME)
	...
	set_target_properties(${PROJECTNAME} PROPERTIES FOLDER "3rd Party/MyGUI/Plugins")
