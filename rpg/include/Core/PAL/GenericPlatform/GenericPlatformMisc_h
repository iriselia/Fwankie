...
namespace EBuildConfigurationsType {
	enum class EBuildConfigurationsType
	{
		/**
	...
	*/
		//std::tstring ToText( EBuildConfigurationsType Configuration );
}
...
namespace EBuildTargetsType {
	...
	*/
	 ...
	 */
	enum class EErrorReportModeType
	{
...
struct FGenericPlatformMisc
{
	...
	*/
	 ...
	 */
	static std::tstring GetMacAddressString();
	 ...
	 */
	static std::tstring GetHashedMacAddressString();
	 ...
	 */
	static std::tstring GetUniqueDeviceId();
	...
	FORCEINLINE static uint32 GetKeyMap( uint16* KeyCodes, std::tstring* KeyNames, uint32 MaxMappings )
	{
		return 0;
	}

	FORCEINLINE static uint32 GetCharKeyMap(uint16* KeyCodes, std::tstring* KeyNames, uint32 MaxMappings)
	{
		return 0;
	}
...
protected:
	...
	* Retrieves some standard key code mappings (usually called by a subclass's GetCharKeyMap)
	 ...
	 */
	static uint32 GetStandardPrintableKeyMap(uint16* KeyCodes, std::tstring* KeyNames, uint32 MaxMappings, bool bMapUppercaseKeys, bool bMapLowercaseKeys);
...
public:
	...
	**/
	...
	{
		return false; //TODO: Fix platform config !!PLATFORM_64BITS;
	}
	 ...
	 */
	static void NormalizePath(std::tstring& InPath)
	{
	}
	...
	*/
	...
	static std::tstring GetDefaultLocale();
	 ...
	 */
	static void SetOverrideGameDir(const std::tstring& InOverrideDir);
	 ...
	 */
	static void GetValidTargetPlatforms(std::vector<std::tstring>& TargetPlatformNames);
	...
	{
		return false; //TODO: Fix joystick config PLATFORM_HAS_TOUCH_MAIN_SCREEN;
	}
