...
class WindowsWindow : public GenericWindow, public IDropTarget
{
public:
	//WindowsWindow();
	~WindowsWindow();
...
public:
	...
	*/
	...
	void Initialize(/*class FWindowsApplication* const Application, */const std::shared_ptr<GenericWindowDefinition> InDefinition, HINSTANCE InHInstance, const std::shared_ptr< WindowsWindow >& InParent, const bool bShowImmediately);
...
public:
	...
	virtual void SetWindowMode(EWindowModeType NewWindowMode) OVERRIDE;

	virtual EWindowModeType GetWindowMode() const OVERRIDE{ return WindowMode; }
	...
	*/
	...
	virtual void AdjustCachedSize(Vector2D& Size) const OVERRIDE;
